...
const ACTIONS: Array<NavigationItem> = [
	...
	},
	{
		type: NavigationItemType.LINK,
		external: true,
		href: 'https://instagram.com/ashwinjadhav818',
...
export default function HomePage() {
	...
	const description = `Hey there, I am a full-stack web developer since 2020. I love to make websites and to keep learning and experimenting with new technologies.`;
				...
				<Content>
					{animations ? (
						<Transition duration={1000}>
							<Title>
								Hey <Wave>👋</Wave> I'm Ashwin, <LineBreak />a{' '}
